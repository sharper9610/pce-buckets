/*
  # Add Reason Field to Off-Plan Items

  Updates the off_plan_items_analysis script to include a reason field explaining why items are off-plan.
  
  Changes:
  - Adds 'reason' field to output
  - Uses dummy data "Not cheapest on eneba" for now
*/
